...
final class EWalletHandler extends AbstractPaymentMethodHandler
{
    ...
    protected function processPayment(
        ...
        if (!$response->isSuccess()) {
            throw new Exception($response->error ?? 'E-Wallet payment initialization failed');
        }
